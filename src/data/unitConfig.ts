...
export const UNITS_DATA: Record<string, UnitData> = {
  jandira: {
    ...
    clinicalDirector: {
      name: 'Dra. Michele Katiane Carvalho Da Silva',
      cro: 'CRO-SP 142214',
    ...
    dentists: [
      {
        ...
        cro: 'CRO-SP 142214',
        photoUrl: '/images/dentistas/dra-michele-silva.webp'
      }
    ],
    testimonials: [
      {
        ...
        rating: 5,
        text: 'Excelente atendimento na OdontoCompany Jandira! A clínica é muito bonita, os profissionais super atenciosos e o tratamento de implante foi super tranquilo.',
        treatment: 'Implante Dentário'
      },
      {
        name: 'Mariana Silveira',
        rating: 5,
        text: 'Coloquei meu aparelho na OdontoCompany Jandira e já vejo muita diferença no meu sorriso. Facilidade no pagamento e equipe maravilhosa!',
        treatment: 'Ortodontia'
      },
      {
        name: 'Luciana Ramos',
        rating: 5,
        text: 'Fiz clareamento e limpeza preventiva na unidade. Atendimento pontual, ambiente muito limpo e profissionais que passam muita segurança. Recomendo a todos de Jandira e região.',
